			...
			<main className="mx-auto max-w-4xl px-4 md:px-8 lg:px-12 py-12">
				...
				<section id="pricing" className="space-y-6">
					<div className="space-x-2 flex">
						<h2 className="text-4xl md:text-5xl tracking-tight font-semibold">Krótki <b className="font-almendra">przegląd</b></h2>
					</div>
					<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
						<Card className="bg-secondary/30 border-input transition-shadow">
							<CardContent className="p-6 space-y-4">
								...
								<p className="text-muted-foreground">
									Od ponad 2 lat tworzę <strong>rozwiązania automatyzujące</strong> dla różnych platform, w tym Discord, Telegram, Instagram i Facebook. Oferuję <strong>spersonalizowane rozwiązania w przystępnej cenie</strong>.
								</p>
							</CardContent>
						</Card>
						...
						<Card className="bg-secondary/30 border-input transition-shadow">
							<CardContent className="p-6 space-y-4">
								...
								<p className="text-muted-foreground">
									Od prawie 5 lat zajmuję się <strong>grafiką komputerową</strong>, tworząc profesjonalne projekty wizualne dopasowane do potrzeb klientów.
								</p>
							</CardContent>
						</Card>
						...
						<Card className="bg-secondary/30 border-input transition-shadow">
							<CardContent className="p-6 space-y-4">
								...
								<p className="text-muted-foreground">
									Od 2 lat projektuję <strong>intuicyjne interfejsy</strong> i <strong>kompleksowe doświadczenia użytkownika</strong>, łącząc estetykę z funkcjonalnością. Tworzę projekty dostosowane do potrzeb użytkowników i celów marketingowych.
								</p>
							</CardContent>
						</Card>
					</div>
